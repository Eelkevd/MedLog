                        ...
                        <table class="table table-striped">
                            <thead>
                              <tr>
                                ...
                                <a href="{{ route('entries.edit', $entry->id) }}" onclick="return confirm('Weet je zeker dat je dit medicijn wilt verwijderen?')" ><span class="oi oi-trash icon"></span></a>
                                <a href="{{ route('entries.delete', $entry->id) }}" ><span class="oi oi-pencil icon"></span></a>
                              </th>
                              </tr>
                            </thead>
                            <tbody>
